      ...
      <section className="hero">
        ...
        <div className="shell hero-grid">
          ...
          <div className="hero-visual">
            <figure><img src={asset('/coaches/alan.jpg')} alt="Origin MK head coach Alan Mineards" /></figure>
